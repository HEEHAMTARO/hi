...
export default function PostEdit() {
  ...
  const validateContact = (rule: any, value: string) => {
    ...
    const phonePattern = /^0\d{9}$/; // Starts with 0 followed by exactly 9 digits
    ...
    if (emailPattern.test(value) && value.includes("@gmail.com")) {
      return Promise.resolve();
    }
      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: "800px", padding: "20px", background: "#fff", borderRadius: "8px", boxShadow: "0 4px 12px rgba(0, 0, 0, 0.1)" }}>
          ...
          <Col style={{ textAlign: "center" }}>
            <Space direction="vertical" size={30}>
              {profileImage ? (
                ...
                <Avatar shape="square" size={200} style={{ backgroundColor: "#ccc" }}>
                  No Image
                </Avatar>
              )}
        ...
        >
          ...
          <Space direction="vertical" size="large" style={{ width: "100%" }}>
            ...
            <Form.Item
              label="เบอร์โทร / อีเมล / ลิงก์"
              name="Contact"
              rules={[{ validator: validateContact }]} // Custom validation rule
            >
              <Input
